...
//		String r1 = "75b6d9ba02da6db30219cd1a4007efa175b6d9ba02da6db3";
//		String ori = "vR8xs2shoRBKNT83yc9BoQ==";
//		String vlu = getDecryptedValue(ori,r1);
//		System.out.println(vlu);
	...
	/**
	 ...
	 private static final String PASSWORD_CRYPT_KEY = "75b6d9ba02da6db30219cd1a4007efa175b6d9ba02da6db3";
	  ...
	  public static String getDecryptedValue(String value,String key) throws UnsupportedEncodingException {
      	 if(StringUtils.isBlank(value)){
      	 	return "";
		 }
		  byte[] valueBytes = Base64.decode(value);
      	  byte[] s1 = decrypt3DES(valueBytes,ByteUtils.fromHexString(key));
